...
namespace math {
   ...
   ////////////////////////////////////////////////////////////////////////
   ///
   /// @fn Plan3D::Plan3D(const Vecteur3& normale, const Vecteur3& pointDuPlan)
   ///
   /// Permet de construire un plan a partir d'une normale au plan et d'un
   /// point sur le plan.  La normale doit etre non nulle.
   ///
   ...
   ///
   ////////////////////////////////////////////////////////////////////////
   Plan3D::Plan3D(const Vecteur3& normale, const Vecteur3& pointDuPlan)
      : normale_(normale) ,
        d_(-((normale[0]+0.01)*pointDuPlan[0] + (normale[1]+0.01)*pointDuPlan[1] + (normale[2]+0.01)*pointDuPlan[2]) )
   {
      //if (normale.estNul());
   ...
   ///
   /// Lire les 4 coefficients qui definissent un plan en 3D.
   /// \f$ Ax + By + Cz + D = 0 \f$
   ///
