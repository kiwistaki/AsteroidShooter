...
namespace math {
   ...
   ///
   /// Constructeur d'une droite 3D a partir de 2 points. \n
   /// Une droite dans l'espace 3d passant par 2 points
   /// @f$  ( P_1, P_2) @f$ est definie par l'equation :
   ///
   ///  \f[  \frac {x - x_1 } {x_2 - x_1} =  \frac { y - y_1 } {y_2 - y_1} =  \frac { z - z_1 } {z_2 - z_1}    \f]
   /// \n\n
   ///
   /// @param[in] point1 : Un point sur la droite.
   /// @param[in] point2 : Un autre point sur la droite (different du premier
   ///                     sinon il y a une levee d'exception).
   ///
      ...
      : direction_( point1, point2 ) , pointDroite_(point1)
   {
      if ( direction_.estNul() ) {
		  // Petit hack facile pour l'instant
		  direction_ = Vecteur3(point1, point2 + Vecteur3(0.01, 0.01, 0.01));
   ...
   /// dans l'espace 3D. La droite ne doit pas etre parallele au plan. \n
   ///
   ///  Si
   ///  @f$ a @f$
   ///  est different de zero, alors l'intersection est donnee par :\n
   ///
   ...
   ///
   ///  Sinon, l'intersection est donnee par :\n
   ///
   ///   \f[  x = x_0 \f]
   ///   \f[  y = y_0 \f]
   ...
   ///  @param[out] intersection : Le resultat de l'intersection @f$ (s, y, z) @f$ .
   ///
   ///  @return Faux si la droite est parallele au plan, donc si donc
   ///          l'intersection ne peut etre trouvee, vrai autrement.
   ///
   ///////////////////////////////////////////////////////////////////////////////
   bool Droite3D::intersection( const Plan3D& planCoupe, Vecteur3& intersection )
   {
      ...
      // On regarde si le plan et la droite sont paralleles.
   ...
   /// defini par 2 points @f$ (P_1, P_2) @f$ et une droite dans l'espace 3D.
   ///
   /// @param[in] point1 : Le premier point du segment.
   /// @param[in] point2 : Le deuxieme point permettant de definir le segment de droite.
   ///
   /// @return    bool : false => la droite est parallele au plan,
   ///                            donc l'intersection ne peut etre trouvee.
   ///
   ...
   ///
   /// @param[in] centre : Point a partir duquel la distance doit etre calculee.
   ///
   /// @return Distance du point a la droite.
   ///
   ////////////////////////////////////////////////////////////////////////
   ...
   ///
   /// @param[in] point : Un point dans l'espace d'où est calculee la
   ///                    perpendiculaire.
   ///
   ...
   Droite3D& Droite3D::operator= (const Droite3D& rhs) {
	   if (this != &rhs) {
		   direction_ = rhs.direction_;
		   pointDroite_ = rhs.pointDroite_;
	   }
