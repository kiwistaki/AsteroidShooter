...
///
/// Surcharge de l'operateur < pour une variable de type @a std::string.
///
/// @param[in] out : L'objet representant le fichier binaire.
/// @param[in] s   : La variable de type @a std::string.
///
/// @return L'objet representant le fichier binaire.
///
////////////////////////////////////////////////////////////////////////
...
///
/// Surcharge de l'operateur < pour une variable de type @a double.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Surcharge de l'operateur < pour une variable de type @a float.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Surcharge de l'operateur < pour une variable de type @a int.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Surcharge de l'operateur < pour une variable de type @a unsigned @a int.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Surcharge de l'operateur < pour une variable de type @a char.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Surcharge de l'operateur < pour une variable de type @a bool.
///
/// @param[in] out : L'objet representant le fichier binaire.
...
///
/// Cette fonction permet d'inserer des caracters nuls (0) dans le fichier
/// binaire.
///
/// @param[in] n : Le nombre de caracteres vides a inserer.
///
///  @return Aucune
///
////////////////////////////////////////////////////////////////////////
