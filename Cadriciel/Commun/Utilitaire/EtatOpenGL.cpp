...
/// Cette macro permet de retourner la chaîne associee a une valeur.
#define COMPARER_VALEUR(x,chaine) if (x == chaine) return #chaine ;
/// Cette macro retourne la valeur par defaut de la variable.
...
///
/// Ce constructeur lit toutes ses variables de l'etat courant de la machine
/// OpenGL.
///
...
{
   // On veut initialiser toutes les variables a 0, mais on ne veut pas
   // briser les objets vecteurs.  On les desalloue donc, on met toute la
   // memoire a zero puis on reinitialise.
...
///
/// Cet operateur permet d'afficher l'etat OpenGL sous une forme lisible.
///
/// @param[in] o    : Le flux de sortie.
/// @param[in] etat : L'etat OpenGL a afficher.
///
...
///
/// @param[in] o     : Le flux de sortie.
/// @param[in] etat1 : Le premier etat OpenGL de la comparaison.
/// @param[in] etat2 : Le second etat OpenGL de la comparaison.
///
/// @return Le flux de sortie.
///
///////////////////////////////////////////////////////////////////////////////
                                   ...
                                   const EtatOpenGL& etat2)
{
   if (memcmp(&etat1.glAccumAlphaBits_, &etat2.glAccumAlphaBits_, sizeof(etat1.glAccumAlphaBits_))) {
      o << "GL_ACCUM_ALPHA_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAccumAlphaBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAccumBlueBits_, &etat2.glAccumBlueBits_, sizeof(etat1.glAccumBlueBits_))) {
      o << "GL_ACCUM_BLUE_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAccumBlueBits()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glAccumClearValue_, etat2.glAccumClearValue_, sizeof(etat1.glAccumClearValue_))) {
      o << "GL_ACCUM_CLEAR_VALUE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAccumClearValue()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAccumGreenBits_, &etat2.glAccumGreenBits_, sizeof(etat1.glAccumGreenBits_))) {
      o << "GL_ACCUM_GREEN_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAccumGreenBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAccumRedBits_, &etat2.glAccumRedBits_, sizeof(etat1.glAccumRedBits_))) {
      o << "GL_ACCUM_RED_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAccumRedBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaBias_, &etat2.glAlphaBias_, sizeof(etat1.glAlphaBias_))) {
      o << "GL_ALPHA_BIAS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaBias()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaBits_, &etat2.glAlphaBits_, sizeof(etat1.glAlphaBits_))) {
      o << "GL_ALPHA_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaScale_, &etat2.glAlphaScale_, sizeof(etat1.glAlphaScale_))) {
      o << "GL_ALPHA_SCALE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaScale()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaTest_, &etat2.glAlphaTest_, sizeof(etat1.glAlphaTest_))) {
      o << "GL_ALPHA_TEST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaTest()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaTestFunc_, &etat2.glAlphaTestFunc_, sizeof(etat1.glAlphaTestFunc_))) {
      o << "GL_ALPHA_TEST_FUNC :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaTestFunc()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAlphaTestRef_, &etat2.glAlphaTestRef_, sizeof(etat1.glAlphaTestRef_))) {
      o << "GL_ALPHA_TEST_REF :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAlphaTestRef()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAttribStackDepth_, &etat2.glAttribStackDepth_, sizeof(etat1.glAttribStackDepth_))) {
      o << "GL_ATTRIB_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAttribStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAutoNormal_, &etat2.glAutoNormal_, sizeof(etat1.glAutoNormal_))) {
      o << "GL_AUTO_NORMAL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAutoNormal()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glAuxBuffers_, &etat2.glAuxBuffers_, sizeof(etat1.glAuxBuffers_))) {
      o << "GL_AUX_BUFFERS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlAuxBuffers()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlend_, &etat2.glBlend_, sizeof(etat1.glBlend_))) {
      o << "GL_BLEND :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlend()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlendDst_, &etat2.glBlendDst_, sizeof(etat1.glBlendDst_))) {
      o << "GL_BLEND_DST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlendDst()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlendSrc_, &etat2.glBlendSrc_, sizeof(etat1.glBlendSrc_))) {
      o << "GL_BLEND_SRC :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlendSrc()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlueBias_, &etat2.glBlueBias_, sizeof(etat1.glBlueBias_))) {
      o << "GL_BLUE_BIAS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlueBias()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlueBits_, &etat2.glBlueBits_, sizeof(etat1.glBlueBits_))) {
      o << "GL_BLUE_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlueBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glBlueScale_, &etat2.glBlueScale_, sizeof(etat1.glBlueScale_))) {
      o << "GL_BLUE_SCALE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlBlueScale()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glClientAttribStackDepth_, &etat2.glClientAttribStackDepth_, sizeof(etat1.glClientAttribStackDepth_))) {
      o << "GL_CLIENT_ATTRIB_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlClientAttribStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorArray_, &etat2.glColorArray_, sizeof(etat1.glColorArray_))) {
      o << "GL_COLOR_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorArraySize_, &etat2.glColorArraySize_, sizeof(etat1.glColorArraySize_))) {
      o << "GL_COLOR_ARRAY_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorArraySize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorArrayStride_, &etat2.glColorArrayStride_, sizeof(etat1.glColorArrayStride_))) {
      o << "GL_COLOR_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorArrayType_, &etat2.glColorArrayType_, sizeof(etat1.glColorArrayType_))) {
      o << "GL_COLOR_ARRAY_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorArrayType()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glColorClearValue_, etat2.glColorClearValue_, sizeof(etat1.glColorClearValue_))) {
      o << "GL_COLOR_CLEAR_VALUE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorClearValue()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorLogicOp_, &etat2.glColorLogicOp_, sizeof(etat1.glColorLogicOp_))) {
      o << "GL_COLOR_LOGIC_OP :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorLogicOp()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorMaterial_, &etat2.glColorMaterial_, sizeof(etat1.glColorMaterial_))) {
      o << "GL_COLOR_MATERIAL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorMaterial()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorMaterialFace_, &etat2.glColorMaterialFace_, sizeof(etat1.glColorMaterialFace_))) {
      o << "GL_COLOR_MATERIAL_FACE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorMaterialFace()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glColorMaterialParameter_, &etat2.glColorMaterialParameter_, sizeof(etat1.glColorMaterialParameter_))) {
      o << "GL_COLOR_MATERIAL_PARAMETER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorMaterialParameter()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glColorWritemask_, etat2.glColorWritemask_, sizeof(etat1.glColorWritemask_))) {
      o << "GL_COLOR_WRITEMASK :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlColorWritemask()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCullFace_, &etat2.glCullFace_, sizeof(etat1.glCullFace_))) {
      o << "GL_CULL_FACE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCullFace()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCullFaceMode_, &etat2.glCullFaceMode_, sizeof(etat1.glCullFaceMode_))) {
      o << "GL_CULL_FACE_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCullFaceMode()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentColor_, etat2.glCurrentColor_, sizeof(etat1.glCurrentColor_))) {
      o << "GL_CURRENT_COLOR :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentColor()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCurrentIndex_, &etat2.glCurrentIndex_, sizeof(etat1.glCurrentIndex_))) {
      o << "GL_CURRENT_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentIndex()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentNormal_, etat2.glCurrentNormal_, sizeof(etat1.glCurrentNormal_))) {
      o << "GL_CURRENT_NORMAL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentNormal()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentRasterColor_, etat2.glCurrentRasterColor_, sizeof(etat1.glCurrentRasterColor_))) {
      o << "GL_CURRENT_RASTER_COLOR :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterColor()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCurrentRasterDistance_, &etat2.glCurrentRasterDistance_, sizeof(etat1.glCurrentRasterDistance_))) {
      o << "GL_CURRENT_RASTER_DISTANCE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterDistance()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCurrentRasterIndex_, &etat2.glCurrentRasterIndex_, sizeof(etat1.glCurrentRasterIndex_))) {
      o << "GL_CURRENT_RASTER_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterIndex()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentRasterPosition_, etat2.glCurrentRasterPosition_, sizeof(etat1.glCurrentRasterPosition_))) {
      o << "GL_CURRENT_RASTER_POSITION :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterPosition()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glCurrentRasterPositionValid_, &etat2.glCurrentRasterPositionValid_, sizeof(etat1.glCurrentRasterPositionValid_))) {
      o << "GL_CURRENT_RASTER_POSITION_VALID :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterPositionValid()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentRasterTextureCoords_, etat2.glCurrentRasterTextureCoords_, sizeof(etat1.glCurrentRasterTextureCoords_))) {
      o << "GL_CURRENT_RASTER_TEXTURE_COORDS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentRasterTextureCoords()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glCurrentTextureCoords_, etat2.glCurrentTextureCoords_, sizeof(etat1.glCurrentTextureCoords_))) {
      o << "GL_CURRENT_TEXTURE_COORDS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlCurrentTextureCoords()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthBias_, &etat2.glDepthBias_, sizeof(etat1.glDepthBias_))) {
      o << "GL_DEPTH_BIAS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthBias()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthBits_, &etat2.glDepthBits_, sizeof(etat1.glDepthBits_))) {
      o << "GL_DEPTH_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthClearValue_, &etat2.glDepthClearValue_, sizeof(etat1.glDepthClearValue_))) {
      o << "GL_DEPTH_CLEAR_VALUE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthClearValue()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthFunc_, &etat2.glDepthFunc_, sizeof(etat1.glDepthFunc_))) {
      o << "GL_DEPTH_FUNC :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthFunc()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glDepthRange_, etat2.glDepthRange_, sizeof(etat1.glDepthRange_))) {
      o << "GL_DEPTH_RANGE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthRange()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthScale_, &etat2.glDepthScale_, sizeof(etat1.glDepthScale_))) {
      o << "GL_DEPTH_SCALE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthScale()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthTest_, &etat2.glDepthTest_, sizeof(etat1.glDepthTest_))) {
      o << "GL_DEPTH_TEST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthTest()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDepthWritemask_, &etat2.glDepthWritemask_, sizeof(etat1.glDepthWritemask_))) {
      o << "GL_DEPTH_WRITEMASK :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDepthWritemask()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDither_, &etat2.glDither_, sizeof(etat1.glDither_))) {
      o << "GL_DITHER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDither()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDoublebuffer_, &etat2.glDoublebuffer_, sizeof(etat1.glDoublebuffer_))) {
      o << "GL_DOUBLEBUFFER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDoublebuffer()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glDrawBuffer_, &etat2.glDrawBuffer_, sizeof(etat1.glDrawBuffer_))) {
      o << "GL_DRAW_BUFFER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlDrawBuffer()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glEdgeFlag_, &etat2.glEdgeFlag_, sizeof(etat1.glEdgeFlag_))) {
      o << "GL_EDGE_FLAG :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlEdgeFlag()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glEdgeFlagArray_, &etat2.glEdgeFlagArray_, sizeof(etat1.glEdgeFlagArray_))) {
      o << "GL_EDGE_FLAG_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlEdgeFlagArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glEdgeFlagArrayStride_, &etat2.glEdgeFlagArrayStride_, sizeof(etat1.glEdgeFlagArrayStride_))) {
      o << "GL_EDGE_FLAG_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlEdgeFlagArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFeedbackBufferSize_, &etat2.glFeedbackBufferSize_, sizeof(etat1.glFeedbackBufferSize_))) {
      o << "GL_FEEDBACK_BUFFER_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFeedbackBufferSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFeedbackBufferType_, &etat2.glFeedbackBufferType_, sizeof(etat1.glFeedbackBufferType_))) {
      o << "GL_FEEDBACK_BUFFER_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFeedbackBufferType()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFog_, &etat2.glFog_, sizeof(etat1.glFog_))) {
      o << "GL_FOG :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFog()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glFogColor_, etat2.glFogColor_, sizeof(etat1.glFogColor_))) {
      o << "GL_FOG_COLOR :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogColor()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogDensity_, &etat2.glFogDensity_, sizeof(etat1.glFogDensity_))) {
      o << "GL_FOG_DENSITY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogDensity()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogEnd_, &etat2.glFogEnd_, sizeof(etat1.glFogEnd_))) {
      o << "GL_FOG_END :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogEnd()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogHint_, &etat2.glFogHint_, sizeof(etat1.glFogHint_))) {
      o << "GL_FOG_HINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogHint()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogIndex_, &etat2.glFogIndex_, sizeof(etat1.glFogIndex_))) {
      o << "GL_FOG_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogIndex()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogMode_, &etat2.glFogMode_, sizeof(etat1.glFogMode_))) {
      o << "GL_FOG_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFogStart_, &etat2.glFogStart_, sizeof(etat1.glFogStart_))) {
      o << "GL_FOG_START :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFogStart()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glFrontFace_, &etat2.glFrontFace_, sizeof(etat1.glFrontFace_))) {
      o << "GL_FRONT_FACE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlFrontFace()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glGreenBias_, &etat2.glGreenBias_, sizeof(etat1.glGreenBias_))) {
      o << "GL_GREEN_BIAS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlGreenBias()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glGreenBits_, &etat2.glGreenBits_, sizeof(etat1.glGreenBits_))) {
      o << "GL_GREEN_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlGreenBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glGreenScale_, &etat2.glGreenScale_, sizeof(etat1.glGreenScale_))) {
      o << "GL_GREEN_SCALE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlGreenScale()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexArray_, &etat2.glIndexArray_, sizeof(etat1.glIndexArray_))) {
      o << "GL_INDEX_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexArrayStride_, &etat2.glIndexArrayStride_, sizeof(etat1.glIndexArrayStride_))) {
      o << "GL_INDEX_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexArrayType_, &etat2.glIndexArrayType_, sizeof(etat1.glIndexArrayType_))) {
      o << "GL_INDEX_ARRAY_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexArrayType()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexBits_, &etat2.glIndexBits_, sizeof(etat1.glIndexBits_))) {
      o << "GL_INDEX_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexClearValue_, &etat2.glIndexClearValue_, sizeof(etat1.glIndexClearValue_))) {
      o << "GL_INDEX_CLEAR_VALUE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexClearValue()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexLogicOp_, &etat2.glIndexLogicOp_, sizeof(etat1.glIndexLogicOp_))) {
      o << "GL_INDEX_LOGIC_OP :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexLogicOp()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexMode_, &etat2.glIndexMode_, sizeof(etat1.glIndexMode_))) {
      o << "GL_INDEX_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexOffset_, &etat2.glIndexOffset_, sizeof(etat1.glIndexOffset_))) {
      o << "GL_INDEX_OFFSET :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexOffset()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexShift_, &etat2.glIndexShift_, sizeof(etat1.glIndexShift_))) {
      o << "GL_INDEX_SHIFT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexShift()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glIndexWritemask_, &etat2.glIndexWritemask_, sizeof(etat1.glIndexWritemask_))) {
      o << "GL_INDEX_WRITEMASK :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlIndexWritemask()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLighting_, &etat2.glLighting_, sizeof(etat1.glLighting_))) {
      o << "GL_LIGHTING :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLighting()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glLightModelAmbient_, etat2.glLightModelAmbient_, sizeof(etat1.glLightModelAmbient_))) {
      o << "GL_LIGHT_MODEL_AMBIENT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLightModelAmbient()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLightModelLocalViewer_, &etat2.glLightModelLocalViewer_, sizeof(etat1.glLightModelLocalViewer_))) {
      o << "GL_LIGHT_MODEL_LOCAL_VIEWER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLightModelLocalViewer()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLightModelTwoSide_, &etat2.glLightModelTwoSide_, sizeof(etat1.glLightModelTwoSide_))) {
      o << "GL_LIGHT_MODEL_TWO_SIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLightModelTwoSide()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineSmooth_, &etat2.glLineSmooth_, sizeof(etat1.glLineSmooth_))) {
      o << "GL_LINE_SMOOTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineSmooth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineSmoothHint_, &etat2.glLineSmoothHint_, sizeof(etat1.glLineSmoothHint_))) {
      o << "GL_LINE_SMOOTH_HINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineSmoothHint()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineStipple_, &etat2.glLineStipple_, sizeof(etat1.glLineStipple_))) {
      o << "GL_LINE_STIPPLE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineStipple()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineStipplePattern_, &etat2.glLineStipplePattern_, sizeof(etat1.glLineStipplePattern_))) {
      o << "GL_LINE_STIPPLE_PATTERN :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineStipplePattern()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineStippleRepeat_, &etat2.glLineStippleRepeat_, sizeof(etat1.glLineStippleRepeat_))) {
      o << "GL_LINE_STIPPLE_REPEAT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineStippleRepeat()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineWidth_, &etat2.glLineWidth_, sizeof(etat1.glLineWidth_))) {
      o << "GL_LINE_WIDTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineWidth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLineWidthGranularity_, &etat2.glLineWidthGranularity_, sizeof(etat1.glLineWidthGranularity_))) {
      o << "GL_LINE_WIDTH_GRANULARITY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLineWidthGranularity()
        << std::endl;
   }
   ...
   if (memcmp(etat1.gllineWidthRange_, etat2.gllineWidthRange_, sizeof(etat1.gllineWidthRange_))) {
      o << "GL_LINE_WIDTH_RANGE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGllineWidthRange()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glListBase_, &etat2.glListBase_, sizeof(etat1.glListBase_))) {
      o << "GL_LIST_BASE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlListBase()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glListIndex_, &etat2.glListIndex_, sizeof(etat1.glListIndex_))) {
      o << "GL_LIST_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlListIndex()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glListMode_, &etat2.glListMode_, sizeof(etat1.glListMode_))) {
      o << "GL_LIST_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlListMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glLogicOpMode_, &etat2.glLogicOpMode_, sizeof(etat1.glLogicOpMode_))) {
      o << "GL_LOGIC_OP_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLogicOpMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1Color4_, &etat2.glMap1Color4_, sizeof(etat1.glMap1Color4_))) {
      o << "GL_MAP1_COLOR_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1Color4()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glMap1GridDomain_, etat2.glMap1GridDomain_, sizeof(etat1.glMap1GridDomain_))) {
      o << "GL_MAP1_GRID_DOMAIN :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1GridDomain()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1GridSegments_, &etat2.glMap1GridSegments_, sizeof(etat1.glMap1GridSegments_))) {
      o << "GL_MAP1_GRID_SEGMENTS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1GridSegments()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1Index_, &etat2.glMap1Index_, sizeof(etat1.glMap1Index_))) {
      o << "GL_MAP1_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1Index()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1Normal_, &etat2.glMap1Normal_, sizeof(etat1.glMap1Normal_))) {
      o << "GL_MAP1_NORMAL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1Normal()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1TextureCoord1_, &etat2.glMap1TextureCoord1_, sizeof(etat1.glMap1TextureCoord1_))) {
      o << "GL_MAP1_TEXTURE_COORD_1 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1TextureCoord1()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1TextureCoord2_, &etat2.glMap1TextureCoord2_, sizeof(etat1.glMap1TextureCoord2_))) {
      o << "GL_MAP1_TEXTURE_COORD_2 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1TextureCoord2()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1TextureCoord3_, &etat2.glMap1TextureCoord3_, sizeof(etat1.glMap1TextureCoord3_))) {
      o << "GL_MAP1_TEXTURE_COORD_3 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1TextureCoord3()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1TextureCoord4_, &etat2.glMap1TextureCoord4_, sizeof(etat1.glMap1TextureCoord4_))) {
      o << "GL_MAP1_TEXTURE_COORD_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1TextureCoord4()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1Vertex3_, &etat2.glMap1Vertex3_, sizeof(etat1.glMap1Vertex3_))) {
      o << "GL_MAP1_VERTEX_3 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1Vertex3()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap1Vertex4_, &etat2.glMap1Vertex4_, sizeof(etat1.glMap1Vertex4_))) {
      o << "GL_MAP1_VERTEX_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap1Vertex4()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2Color4_, &etat2.glMap2Color4_, sizeof(etat1.glMap2Color4_))) {
      o << "GL_MAP2_COLOR_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2Color4()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glMap2GridDomain_, etat2.glMap2GridDomain_, sizeof(etat1.glMap2GridDomain_))) {
      o << "GL_MAP2_GRID_DOMAIN :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2GridDomain()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glMap2GridSegments_, etat2.glMap2GridSegments_, sizeof(etat1.glMap2GridSegments_))) {
      o << "GL_MAP2_GRID_SEGMENTS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2GridSegments()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2Index_, &etat2.glMap2Index_, sizeof(etat1.glMap2Index_))) {
      o << "GL_MAP2_INDEX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2Index()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2Normal_, &etat2.glMap2Normal_, sizeof(etat1.glMap2Normal_))) {
      o << "GL_MAP2_NORMAL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2Normal()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2TextureCoord1_, &etat2.glMap2TextureCoord1_, sizeof(etat1.glMap2TextureCoord1_))) {
      o << "GL_MAP2_TEXTURE_COORD_1 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2TextureCoord1()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2TextureCoord2_, &etat2.glMap2TextureCoord2_, sizeof(etat1.glMap2TextureCoord2_))) {
      o << "GL_MAP2_TEXTURE_COORD_2 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2TextureCoord2()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2TextureCoord3_, &etat2.glMap2TextureCoord3_, sizeof(etat1.glMap2TextureCoord3_))) {
      o << "GL_MAP2_TEXTURE_COORD_3 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2TextureCoord3()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2TextureCoord4_, &etat2.glMap2TextureCoord4_, sizeof(etat1.glMap2TextureCoord4_))) {
      o << "GL_MAP2_TEXTURE_COORD_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2TextureCoord4()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2Vertex3_, &etat2.glMap2Vertex3_, sizeof(etat1.glMap2Vertex3_))) {
      o << "GL_MAP2_VERTEX_3 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2Vertex3()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMap2Vertex4_, &etat2.glMap2Vertex4_, sizeof(etat1.glMap2Vertex4_))) {
      o << "GL_MAP2_VERTEX_4 :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMap2Vertex4()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMapColor_, &etat2.glMapColor_, sizeof(etat1.glMapColor_))) {
      o << "GL_MAP_COLOR :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMapColor()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMapStencil_, &etat2.glMapStencil_, sizeof(etat1.glMapStencil_))) {
      o << "GL_MAP_STENCIL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMapStencil()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMatrixMode_, &etat2.glMatrixMode_, sizeof(etat1.glMatrixMode_))) {
      o << "GL_MATRIX_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMatrixMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxClientAttribStackDepth_, &etat2.glMaxClientAttribStackDepth_, sizeof(etat1.glMaxClientAttribStackDepth_))) {
      o << "GL_MAX_CLIENT_ATTRIB_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxClientAttribStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxAttribStackDepth_, &etat2.glMaxAttribStackDepth_, sizeof(etat1.glMaxAttribStackDepth_))) {
      o << "GL_MAX_ATTRIB_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxAttribStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxClipPlanes_, &etat2.glMaxClipPlanes_, sizeof(etat1.glMaxClipPlanes_))) {
      o << "GL_MAX_CLIP_PLANES :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxClipPlanes()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxEvalOrder_, &etat2.glMaxEvalOrder_, sizeof(etat1.glMaxEvalOrder_))) {
      o << "GL_MAX_EVAL_ORDER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxEvalOrder()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxLights_, &etat2.glMaxLights_, sizeof(etat1.glMaxLights_))) {
      o << "GL_MAX_LIGHTS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxLights()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxListNesting_, &etat2.glMaxListNesting_, sizeof(etat1.glMaxListNesting_))) {
      o << "GL_MAX_LIST_NESTING :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxListNesting()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxModelviewStackDepth_, &etat2.glMaxModelviewStackDepth_, sizeof(etat1.glMaxModelviewStackDepth_))) {
      o << "GL_MAX_MODELVIEW_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxModelviewStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxNameStackDepth_, &etat2.glMaxNameStackDepth_, sizeof(etat1.glMaxNameStackDepth_))) {
      o << "GL_MAX_NAME_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxNameStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxPixelMapTable_, &etat2.glMaxPixelMapTable_, sizeof(etat1.glMaxPixelMapTable_))) {
      o << "GL_MAX_PIXEL_MAP_TABLE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxPixelMapTable()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxProjectionStackDepth_, &etat2.glMaxProjectionStackDepth_, sizeof(etat1.glMaxProjectionStackDepth_))) {
      o << "GL_MAX_PROJECTION_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxProjectionStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxTextureSize_, &etat2.glMaxTextureSize_, sizeof(etat1.glMaxTextureSize_))) {
      o << "GL_MAX_TEXTURE_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxTextureSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glMaxTextureStackDepth_, &etat2.glMaxTextureStackDepth_, sizeof(etat1.glMaxTextureStackDepth_))) {
      o << "GL_MAX_TEXTURE_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxTextureStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glMaxViewportDims_, etat2.glMaxViewportDims_, sizeof(etat1.glMaxViewportDims_))) {
      o << "GL_MAX_VIEWPORT_DIMS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlMaxViewportDims()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glModelviewMatrix_, etat2.glModelviewMatrix_, sizeof(etat1.glModelviewMatrix_))) {
      o << "GL_MODELVIEW_MATRIX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlModelviewMatrix()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glModelviewStackDepth_, &etat2.glModelviewStackDepth_, sizeof(etat1.glModelviewStackDepth_))) {
      o << "GL_MODELVIEW_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlModelviewStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glNameStackDepth_, &etat2.glNameStackDepth_, sizeof(etat1.glNameStackDepth_))) {
      o << "GL_NAME_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlNameStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glNormalArray_, &etat2.glNormalArray_, sizeof(etat1.glNormalArray_))) {
      o << "GL_NORMAL_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlNormalArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glNormalArrayStride_, &etat2.glNormalArrayStride_, sizeof(etat1.glNormalArrayStride_))) {
      o << "GL_NORMAL_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlNormalArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glNormalArrayType_, &etat2.glNormalArrayType_, sizeof(etat1.glNormalArrayType_))) {
      o << "GL_NORMAL_ARRAY_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlNormalArrayType()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glNormalize_, &etat2.glNormalize_, sizeof(etat1.glNormalize_))) {
      o << "GL_NORMALIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlNormalize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackAlignment_, &etat2.glPackAlignment_, sizeof(etat1.glPackAlignment_))) {
      o << "GL_PACK_ALIGNMENT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackAlignment()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackLsbFirst_, &etat2.glPackLsbFirst_, sizeof(etat1.glPackLsbFirst_))) {
      o << "GL_PACK_LSB_FIRST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackLsbFirst()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackRowLength_, &etat2.glPackRowLength_, sizeof(etat1.glPackRowLength_))) {
      o << "GL_PACK_ROW_LENGTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackRowLength()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackSkipPixels_, &etat2.glPackSkipPixels_, sizeof(etat1.glPackSkipPixels_))) {
      o << "GL_PACK_SKIP_PIXELS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackSkipPixels()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackSkipRows_, &etat2.glPackSkipRows_, sizeof(etat1.glPackSkipRows_))) {
      o << "GL_PACK_SKIP_ROWS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackSkipRows()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPackSwapBytes_, &etat2.glPackSwapBytes_, sizeof(etat1.glPackSwapBytes_))) {
      o << "GL_PACK_SWAP_BYTES :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPackSwapBytes()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPerspectiveCorrectionHint_, &etat2.glPerspectiveCorrectionHint_, sizeof(etat1.glPerspectiveCorrectionHint_))) {
      o << "GL_PERSPECTIVE_CORRECTION_HINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPerspectiveCorrectionHint()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapAToASize_, &etat2.glPixelMapAToASize_, sizeof(etat1.glPixelMapAToASize_))) {
      o << "GL_PIXEL_MAP_A_TO_A_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapAToASize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapBToBSize_, &etat2.glPixelMapBToBSize_, sizeof(etat1.glPixelMapBToBSize_))) {
      o << "GL_PIXEL_MAP_B_TO_B_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapBToBSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapGToGSize_, &etat2.glPixelMapGToGSize_, sizeof(etat1.glPixelMapGToGSize_))) {
      o << "GL_PIXEL_MAP_G_TO_G_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapGToGSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapIToASize_, &etat2.glPixelMapIToASize_, sizeof(etat1.glPixelMapIToASize_))) {
      o << "GL_PIXEL_MAP_I_TO_A_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapIToASize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapIToBSize_, &etat2.glPixelMapIToBSize_, sizeof(etat1.glPixelMapIToBSize_))) {
      o << "GL_PIXEL_MAP_I_TO_B_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapIToBSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapIToGSize_, &etat2.glPixelMapIToGSize_, sizeof(etat1.glPixelMapIToGSize_))) {
      o << "GL_PIXEL_MAP_I_TO_G_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapIToGSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapIToISize_, &etat2.glPixelMapIToISize_, sizeof(etat1.glPixelMapIToISize_))) {
      o << "GL_PIXEL_MAP_I_TO_I_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapIToISize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapIToRSize_, &etat2.glPixelMapIToRSize_, sizeof(etat1.glPixelMapIToRSize_))) {
      o << "GL_PIXEL_MAP_I_TO_R_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapIToRSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapRToRSize_, &etat2.glPixelMapRToRSize_, sizeof(etat1.glPixelMapRToRSize_))) {
      o << "GL_PIXEL_MAP_R_TO_R_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapRToRSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPixelMapSToSSize_, &etat2.glPixelMapSToSSize_, sizeof(etat1.glPixelMapSToSSize_))) {
      o << "GL_PIXEL_MAP_S_TO_S_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPixelMapSToSSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPointSize_, &etat2.glPointSize_, sizeof(etat1.glPointSize_))) {
      o << "GL_POINT_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPointSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPointSizeGranularity_, &etat2.glPointSizeGranularity_, sizeof(etat1.glPointSizeGranularity_))) {
      o << "GL_POINT_SIZE_GRANULARITY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPointSizeGranularity()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glPointSizeRange_, etat2.glPointSizeRange_, sizeof(etat1.glPointSizeRange_))) {
      o << "GL_POINT_SIZE_RANGE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPointSizeRange()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPointSmooth_, &etat2.glPointSmooth_, sizeof(etat1.glPointSmooth_))) {
      o << "GL_POINT_SMOOTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPointSmooth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPointSmoothHint_, &etat2.glPointSmoothHint_, sizeof(etat1.glPointSmoothHint_))) {
      o << "GL_POINT_SMOOTH_HINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPointSmoothHint()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glPolygonMode_, etat2.glPolygonMode_, sizeof(etat1.glPolygonMode_))) {
      o << "GL_POLYGON_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonOffsetFactor_, &etat2.glPolygonOffsetFactor_, sizeof(etat1.glPolygonOffsetFactor_))) {
      o << "GL_POLYGON_OFFSET_FACTOR :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonOffsetFactor()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonOffsetUnits_, &etat2.glPolygonOffsetUnits_, sizeof(etat1.glPolygonOffsetUnits_))) {
      o << "GL_POLYGON_OFFSET_UNITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonOffsetUnits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonOffsetFill_, &etat2.glPolygonOffsetFill_, sizeof(etat1.glPolygonOffsetFill_))) {
      o << "GL_POLYGON_OFFSET_FILL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonOffsetFill()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonOffsetLine_, &etat2.glPolygonOffsetLine_, sizeof(etat1.glPolygonOffsetLine_))) {
      o << "GL_POLYGON_OFFSET_LINE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonOffsetLine()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonOffsetPoint_, &etat2.glPolygonOffsetPoint_, sizeof(etat1.glPolygonOffsetPoint_))) {
      o << "GL_POLYGON_OFFSET_POINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonOffsetPoint()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonSmooth_, &etat2.glPolygonSmooth_, sizeof(etat1.glPolygonSmooth_))) {
      o << "GL_POLYGON_SMOOTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonSmooth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonSmoothHint_, &etat2.glPolygonSmoothHint_, sizeof(etat1.glPolygonSmoothHint_))) {
      o << "GL_POLYGON_SMOOTH_HINT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonSmoothHint()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glPolygonStipple_, &etat2.glPolygonStipple_, sizeof(etat1.glPolygonStipple_))) {
      o << "GL_POLYGON_STIPPLE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlPolygonStipple()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glProjectionMatrix_, etat2.glProjectionMatrix_, sizeof(etat1.glProjectionMatrix_))) {
      o << "GL_PROJECTION_MATRIX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlProjectionMatrix()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glProjectionStackDepth_, &etat2.glProjectionStackDepth_, sizeof(etat1.glProjectionStackDepth_))) {
      o << "GL_PROJECTION_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlProjectionStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glReadBuffer_, &etat2.glReadBuffer_, sizeof(etat1.glReadBuffer_))) {
      o << "GL_READ_BUFFER :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlReadBuffer()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glRedBias_, &etat2.glRedBias_, sizeof(etat1.glRedBias_))) {
      o << "GL_RED_BIAS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlRedBias()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glRedBits_, &etat2.glRedBits_, sizeof(etat1.glRedBits_))) {
      o << "GL_RED_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlRedBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glRedScale_, &etat2.glRedScale_, sizeof(etat1.glRedScale_))) {
      o << "GL_RED_SCALE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlRedScale()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glRenderMode_, &etat2.glRenderMode_, sizeof(etat1.glRenderMode_))) {
      o << "GL_RENDER_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlRenderMode()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glRgbaMode_, &etat2.glRgbaMode_, sizeof(etat1.glRgbaMode_))) {
      o << "GL_RGBA_MODE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlRgbaMode()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glScissorBox_, etat2.glScissorBox_, sizeof(etat1.glScissorBox_))) {
      o << "GL_SCISSOR_BOX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlScissorBox()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glScissorTest_, &etat2.glScissorTest_, sizeof(etat1.glScissorTest_))) {
      o << "GL_SCISSOR_TEST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlScissorTest()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glSelectionBufferSize_, &etat2.glSelectionBufferSize_, sizeof(etat1.glSelectionBufferSize_))) {
      o << "GL_SELECTION_BUFFER_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlSelectionBufferSize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glShadeModel_, &etat2.glShadeModel_, sizeof(etat1.glShadeModel_))) {
      o << "GL_SHADE_MODEL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlShadeModel()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilBits_, &etat2.glStencilBits_, sizeof(etat1.glStencilBits_))) {
      o << "GL_STENCIL_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilClearValue_, &etat2.glStencilClearValue_, sizeof(etat1.glStencilClearValue_))) {
      o << "GL_STENCIL_CLEAR_VALUE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilClearValue()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilFail_, &etat2.glStencilFail_, sizeof(etat1.glStencilFail_))) {
      o << "GL_STENCIL_FAIL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilFail()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilFunc_, &etat2.glStencilFunc_, sizeof(etat1.glStencilFunc_))) {
      o << "GL_STENCIL_FUNC :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilFunc()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilPassDepthFail_, &etat2.glStencilPassDepthFail_, sizeof(etat1.glStencilPassDepthFail_))) {
      o << "GL_STENCIL_PASS_DEPTH_FAIL :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilPassDepthFail()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilPassDepthPass_, &etat2.glStencilPassDepthPass_, sizeof(etat1.glStencilPassDepthPass_))) {
      o << "GL_STENCIL_PASS_DEPTH_PASS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilPassDepthPass()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilRef_, &etat2.glStencilRef_, sizeof(etat1.glStencilRef_))) {
      o << "GL_STENCIL_REF :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilRef()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilTest_, &etat2.glStencilTest_, sizeof(etat1.glStencilTest_))) {
      o << "GL_STENCIL_TEST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilTest()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilValueMask_, &etat2.glStencilValueMask_, sizeof(etat1.glStencilValueMask_))) {
      o << "GL_STENCIL_VALUE_MASK :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilValueMask()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStencilWritemask_, &etat2.glStencilWritemask_, sizeof(etat1.glStencilWritemask_))) {
      o << "GL_STENCIL_WRITEMASK :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStencilWritemask()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glStereo_, &etat2.glStereo_, sizeof(etat1.glStereo_))) {
      o << "GL_STEREO :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlStereo()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glSubpixelBits_, &etat2.glSubpixelBits_, sizeof(etat1.glSubpixelBits_))) {
      o << "GL_SUBPIXEL_BITS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlSubpixelBits()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTexture1D_, &etat2.glTexture1D_, sizeof(etat1.glTexture1D_))) {
      o << "GL_TEXTURE_1D :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTexture1D()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureBinding1D_, &etat2.glTextureBinding1D_, sizeof(etat1.glTextureBinding1D_))) {
      o << "GL_TEXTURE_BINDING_1D :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureBinding1D()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTexture2D_, &etat2.glTexture2D_, sizeof(etat1.glTexture2D_))) {
      o << "GL_TEXTURE_2D :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTexture2D()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureBinding2D_, &etat2.glTextureBinding2D_, sizeof(etat1.glTextureBinding2D_))) {
      o << "GL_TEXTURE_BINDING_2D :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureBinding2D()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureCoordArray_, &etat2.glTextureCoordArray_, sizeof(etat1.glTextureCoordArray_))) {
      o << "GL_TEXTURE_COORD_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureCoordArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureCoordArraySize_, &etat2.glTextureCoordArraySize_, sizeof(etat1.glTextureCoordArraySize_))) {
      o << "GL_TEXTURE_COORD_ARRAY_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureCoordArraySize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureCoordArrayStride_, &etat2.glTextureCoordArrayStride_, sizeof(etat1.glTextureCoordArrayStride_))) {
      o << "GL_TEXTURE_COORD_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureCoordArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureCoordArrayType_, &etat2.glTextureCoordArrayType_, sizeof(etat1.glTextureCoordArrayType_))) {
      o << "GL_TEXTURE_COORD_ARRAY_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureCoordArrayType()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureGenQ_, &etat2.glTextureGenQ_, sizeof(etat1.glTextureGenQ_))) {
      o << "GL_TEXTURE_GEN_Q :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureGenQ()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureGenR_, &etat2.glTextureGenR_, sizeof(etat1.glTextureGenR_))) {
      o << "GL_TEXTURE_GEN_R :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureGenR()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureGenS_, &etat2.glTextureGenS_, sizeof(etat1.glTextureGenS_))) {
      o << "GL_TEXTURE_GEN_S :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureGenS()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureGenT_, &etat2.glTextureGenT_, sizeof(etat1.glTextureGenT_))) {
      o << "GL_TEXTURE_GEN_T :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureGenT()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glTextureMatrix_, etat2.glTextureMatrix_, sizeof(etat1.glTextureMatrix_))) {
      o << "GL_TEXTURE_MATRIX :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureMatrix()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glTextureStackDepth_, &etat2.glTextureStackDepth_, sizeof(etat1.glTextureStackDepth_))) {
      o << "GL_TEXTURE_STACK_DEPTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlTextureStackDepth()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackAlignment_, &etat2.glUnpackAlignment_, sizeof(etat1.glUnpackAlignment_))) {
      o << "GL_UNPACK_ALIGNMENT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackAlignment()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackLsbFirst_, &etat2.glUnpackLsbFirst_, sizeof(etat1.glUnpackLsbFirst_))) {
      o << "GL_UNPACK_LSB_FIRST :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackLsbFirst()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackRowLength_, &etat2.glUnpackRowLength_, sizeof(etat1.glUnpackRowLength_))) {
      o << "GL_UNPACK_ROW_LENGTH :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackRowLength()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackSkipPixels_, &etat2.glUnpackSkipPixels_, sizeof(etat1.glUnpackSkipPixels_))) {
      o << "GL_UNPACK_SKIP_PIXELS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackSkipPixels()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackSkipRows_, &etat2.glUnpackSkipRows_, sizeof(etat1.glUnpackSkipRows_))) {
      o << "GL_UNPACK_SKIP_ROWS :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackSkipRows()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glUnpackSwapBytes_, &etat2.glUnpackSwapBytes_, sizeof(etat1.glUnpackSwapBytes_))) {
      o << "GL_UNPACK_SWAP_BYTES :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlUnpackSwapBytes()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glVertexArray_, &etat2.glVertexArray_, sizeof(etat1.glVertexArray_))) {
      o << "GL_VERTEX_ARRAY :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlVertexArray()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glVertexArraySize_, &etat2.glVertexArraySize_, sizeof(etat1.glVertexArraySize_))) {
      o << "GL_VERTEX_ARRAY_SIZE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlVertexArraySize()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glVertexArrayStride_, &etat2.glVertexArrayStride_, sizeof(etat1.glVertexArrayStride_))) {
      o << "GL_VERTEX_ARRAY_STRIDE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlVertexArrayStride()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glVertexArrayType_, &etat2.glVertexArrayType_, sizeof(etat1.glVertexArrayType_))) {
      o << "GL_VERTEX_ARRAY_TYPE :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlVertexArrayType()
        << std::endl;
   }
   ...
   if (memcmp(etat1.glViewport_, etat2.glViewport_, sizeof(etat1.glViewport_))) {
      o << "GL_VIEWPORT :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlViewport()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glZoomX_, &etat2.glZoomX_, sizeof(etat1.glZoomX_))) {
      o << "GL_ZOOM_X :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlZoomX()
        << std::endl;
   }
   ...
   if (memcmp(&etat1.glZoomY_, &etat2.glZoomY_, sizeof(etat1.glZoomY_))) {
      o << "GL_ZOOM_Y :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlZoomY()
        << std::endl;
   }
   ...
   if (different) {
      o << "GL_CLIP_PLANEi :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlClipPlanei()
        << std::endl;
   }
   ...
   if (different) {
      o << "GL_LIGHTi :"
        ...
        << "\nApres : " << etat2.obtenirChaineGlLighti()
        << std::endl;
   }
}
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ACCUM_ALPHA_BITS.
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_ACCUM_ALPHA_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ACCUM_BLUE_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_ACCUM_BLUE_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ACCUM_CLEAR_VALUE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ACCUM_CLEAR_VALUE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ACCUM_GREEN_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_ACCUM_GREEN_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ACCUM_RED_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_ACCUM_RED_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_BIAS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ALPHA_BIAS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_ALPHA_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_SCALE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ALPHA_SCALE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_TEST.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ALPHA_TEST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_TEST_FUNC.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ALPHA_TEST_FUNC.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ALPHA_TEST_REF.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ALPHA_TEST_REF.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ATTRIB_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_ATTRIB_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_AUTO_NORMAL.
///
/// Selon le man page, cet attribut:
///
...
/// See glMap2.
///
/// @return Une chaîne representant l'attribut GL_AUTO_NORMAL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_AUX_BUFFERS.
///
/// Selon le man page, cet attribut:
///
...
/// initial value is 0.
///
/// @return Une chaîne representant l'attribut GL_AUX_BUFFERS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLEND.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_BLEND.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLEND_DST.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_BLEND_DST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLEND_SRC.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_BLEND_SRC.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLUE_BIAS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_BLUE_BIAS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLUE_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_BLUE_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_BLUE_SCALE.
///
/// Selon le man page, cet attribut:
///
...
/// transfers. The initial value is 1. See glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_BLUE_SCALE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CLIENT_ATTRIB_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CLIENT_ATTRIB_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CLIP_PLANEi.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CLIP_PLANEi.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_ARRAY_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_ARRAY_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_ARRAY_TYPE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_ARRAY_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_CLEAR_VALUE.
///
/// Selon le man page, cet attribut:
///
/// params returns four values: the red, green, blue, and alpha values used to
...
/// See glClearColor.
///
/// @return Une chaîne representant l'attribut GL_COLOR_CLEAR_VALUE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_LOGIC_OP.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_LOGIC_OP.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_MATERIAL.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_MATERIAL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_MATERIAL_FACE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_MATERIAL_FACE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_MATERIAL_PARAMETER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_MATERIAL_PARAMETER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_COLOR_WRITEMASK.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_COLOR_WRITEMASK.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CULL_FACE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CULL_FACE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CULL_FACE_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CULL_FACE_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_COLOR.
///
/// Selon le man page, cet attribut:
///
...
/// (1, 1, 1, 1).
///
/// @return Une chaîne representant l'attribut GL_CURRENT_COLOR.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_INDEX.
///
/// Selon le man page, cet attribut:
///
...
/// See glIndex.
///
/// @return Une chaîne representant l'attribut GL_CURRENT_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_NORMAL.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_NORMAL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_COLOR.
///
/// Selon le man page, cet attribut:
///
/// params returns four values: the red, green, blue, and alpha values of the
...
/// See glRasterPos.
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_COLOR.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_DISTANCE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_DISTANCE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_INDEX.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_POSITION.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_POSITION.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_POSITION_VALID.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_POSITION_VALID.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_RASTER_TEXTURE_COORDS.
///
/// Selon le man page, cet attribut:
///
...
/// glTexCoord.
///
/// @return Une chaîne representant l'attribut GL_CURRENT_RASTER_TEXTURE_COORDS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_CURRENT_TEXTURE_COORDS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_CURRENT_TEXTURE_COORDS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_BIAS.
///
/// Selon le man page, cet attribut:
///
...
/// transfers. The initial value is 0. See glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_DEPTH_BIAS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_BITS.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, the number of bitplanes in the depth buffer.
///
/// @return Une chaîne representant l'attribut GL_DEPTH_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_CLEAR_VALUE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DEPTH_CLEAR_VALUE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_FUNC.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DEPTH_FUNC.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_RANGE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DEPTH_RANGE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_SCALE.
///
/// Selon le man page, cet attribut:
///
...
/// transfers. The initial value is 1. See glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_DEPTH_SCALE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_TEST.
///
/// Selon le man page, cet attribut:
///
...
/// glDepthRange.
///
/// @return Une chaîne representant l'attribut GL_DEPTH_TEST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DEPTH_WRITEMASK.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DEPTH_WRITEMASK.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DITHER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DITHER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DOUBLEBUFFER.
///
/// Selon le man page, cet attribut:
///
...
/// is supported.
///
/// @return Une chaîne representant l'attribut GL_DOUBLEBUFFER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_DRAW_BUFFER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_DRAW_BUFFER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_EDGE_FLAG.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_EDGE_FLAG.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_EDGE_FLAG_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_EDGE_FLAG_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_EDGE_FLAG_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_EDGE_FLAG_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FEEDBACK_BUFFER_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// glFeedbackBuffer.
///
/// @return Une chaîne representant l'attribut GL_FEEDBACK_BUFFER_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FEEDBACK_BUFFER_TYPE.
///
/// Selon le man page, cet attribut:
///
...
/// glFeedbackBuffer.
///
/// @return Une chaîne representant l'attribut GL_FEEDBACK_BUFFER_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_COLOR.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG_COLOR.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_DENSITY.
///
/// Selon le man page, cet attribut:
///
...
/// 1. See glFog.
///
/// @return Une chaîne representant l'attribut GL_FOG_DENSITY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_END.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG_END.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_HINT.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG_HINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_INDEX.
///
/// Selon le man page, cet attribut:
///
...
/// See glFog.
///
/// @return Une chaîne representant l'attribut GL_FOG_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FOG_START.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FOG_START.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_FRONT_FACE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_FRONT_FACE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_GREEN_BIAS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_GREEN_BIAS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_GREEN_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_GREEN_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_GREEN_SCALE.
///
/// Selon le man page, cet attribut:
///
...
/// transfers. The initial value is 1. See glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_GREEN_SCALE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
/// glIndexPointer.
///
/// @return Une chaîne representant l'attribut GL_INDEX_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_ARRAY_TYPE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_ARRAY_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_INDEX_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_CLEAR_VALUE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_CLEAR_VALUE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_LOGIC_OP.
///
/// Selon le man page, cet attribut:
///
...
/// The initial value is GL_FALSE. See glLogicOp.
///
/// @return Une chaîne representant l'attribut GL_INDEX_LOGIC_OP.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_OFFSET.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_OFFSET.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_SHIFT.
///
/// Selon le man page, cet attribut:
///
...
/// glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_INDEX_SHIFT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_INDEX_WRITEMASK.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_INDEX_WRITEMASK.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIGHTi.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether the specified
...
/// glLightModel.
///
/// @return Une chaîne representant l'attribut GL_LIGHTi.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIGHTING.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LIGHTING.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIGHT_MODEL_AMBIENT.
///
/// Selon le man page, cet attribut:
///
/// params returns four values: the red, green, blue, and alpha components of
...
///
/// @return Une chaîne representant l'attribut GL_LIGHT_MODEL_AMBIENT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIGHT_MODEL_LOCAL_VIEWER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LIGHT_MODEL_LOCAL_VIEWER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIGHT_MODEL_TWO_SIDE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LIGHT_MODEL_TWO_SIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_SMOOTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_SMOOTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_SMOOTH_HINT.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating the mode of the
...
///
/// @return Une chaîne representant l'attribut GL_LINE_SMOOTH_HINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_STIPPLE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_STIPPLE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_STIPPLE_PATTERN.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_STIPPLE_PATTERN.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_STIPPLE_REPEAT.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_STIPPLE_REPEAT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_WIDTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_WIDTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_WIDTH_GRANULARITY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_WIDTH_GRANULARITY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LINE_WIDTH_RANGE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LINE_WIDTH_RANGE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIST_BASE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LIST_BASE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIST_INDEX.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LIST_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LIST_MODE.
///
/// Selon le man page, cet attribut:
///
...
/// is 0. See glNewList.
///
/// @return Une chaîne representant l'attribut GL_LIST_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_LOGIC_OP_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_LOGIC_OP_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_COLOR_4.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP1_COLOR_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_GRID_DOMAIN.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP1_GRID_DOMAIN.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_GRID_SEGMENTS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP1_GRID_SEGMENTS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_INDEX.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP1_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_NORMAL.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP1_NORMAL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_1.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_1.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_2.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_2.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_3.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_3.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_4.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_TEXTURE_COORD_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_VERTEX_3.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_VERTEX_3.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP1_VERTEX_4.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 1D evaluation
...
/// glMap1.
///
/// @return Une chaîne representant l'attribut GL_MAP1_VERTEX_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_COLOR_4.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_COLOR_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_GRID_DOMAIN.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_GRID_DOMAIN.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_GRID_SEGMENTS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_GRID_SEGMENTS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_INDEX.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_INDEX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_NORMAL.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_NORMAL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_1.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
///
/// @return Une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_1.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_2.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_2.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_3.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
/// glMap2.
///
/// @return Une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_3.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_4.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
/// glMap2.
///
/// @return Une chaîne representant l'attribut GL_MAP2_TEXTURE_COORD_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_VERTEX_3.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_VERTEX_3.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP2_VERTEX_4.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether 2D evaluation
...
///
/// @return Une chaîne representant l'attribut GL_MAP2_VERTEX_4.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP_COLOR.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP_COLOR.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAP_STENCIL.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAP_STENCIL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MATRIX_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MATRIX_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_CLIENT_ATTRIB_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_CLIENT_ATTRIB_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_ATTRIB_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_ATTRIB_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_CLIP_PLANES.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_CLIP_PLANES.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_EVAL_ORDER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_EVAL_ORDER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_LIGHTS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_LIGHTS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_LIST_NESTING.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_LIST_NESTING.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_MODELVIEW_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_MODELVIEW_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_NAME_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_NAME_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_PIXEL_MAP_TABLE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_PIXEL_MAP_TABLE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_PROJECTION_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_PROJECTION_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_TEXTURE_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_TEXTURE_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_TEXTURE_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
/// matrix stack. The value must be at least 2. See glPushMatrix.
///
/// @return Une chaîne representant l'attribut GL_MAX_TEXTURE_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MAX_VIEWPORT_DIMS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MAX_VIEWPORT_DIMS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MODELVIEW_MATRIX.
///
/// Selon le man page, cet attribut:
///
...
/// glPushMatrix.
///
/// @return Une chaîne representant l'attribut GL_MODELVIEW_MATRIX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_MODELVIEW_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_MODELVIEW_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_NAME_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_NAME_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_NORMAL_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_NORMAL_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_NORMAL_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_NORMAL_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_NORMAL_ARRAY_TYPE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_NORMAL_ARRAY_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_NORMALIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_NORMALIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_ALIGNMENT.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PACK_ALIGNMENT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_LSB_FIRST.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PACK_LSB_FIRST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_ROW_LENGTH.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PACK_ROW_LENGTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_SKIP_PIXELS.
///
/// Selon le man page, cet attribut:
///
...
/// glPixelStore.
///
/// @return Une chaîne representant l'attribut GL_PACK_SKIP_PIXELS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_SKIP_ROWS.
///
/// Selon le man page, cet attribut:
///
...
/// glPixelStore.
///
/// @return Une chaîne representant l'attribut GL_PACK_SKIP_ROWS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PACK_SWAP_BYTES.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PACK_SWAP_BYTES.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PERSPECTIVE_CORRECTION_HINT.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating the mode of the
...
/// glHint.
///
/// @return Une chaîne representant l'attribut GL_PERSPECTIVE_CORRECTION_HINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_A_TO_A_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_A_TO_A_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_B_TO_B_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_B_TO_B_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_G_TO_G_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_G_TO_G_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_A_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_A_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_B_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_B_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_G_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_G_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_I_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_I_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_R_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_I_TO_R_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_R_TO_R_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// table. The initial value is 1. See glPixelMap.
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_R_TO_R_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PIXEL_MAP_S_TO_S_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PIXEL_MAP_S_TO_S_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POINT_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// initial value is 1.
///
/// @return Une chaîne representant l'attribut GL_POINT_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POINT_SIZE_GRANULARITY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_POINT_SIZE_GRANULARITY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POINT_SIZE_RANGE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_POINT_SIZE_RANGE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POINT_SMOOTH.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether antialiasing of
...
///
/// @return Une chaîne representant l'attribut GL_POINT_SMOOTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POINT_SMOOTH_HINT.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating the mode of the
...
///
/// @return Une chaîne representant l'attribut GL_POINT_SMOOTH_HINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_POLYGON_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_OFFSET_FACTOR.
///
/// Selon le man page, cet attribut:
///
...
/// glPolygonOffset.
///
/// @return Une chaîne representant l'attribut GL_POLYGON_OFFSET_FACTOR.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_OFFSET_UNITS.
///
/// Selon le man page, cet attribut:
///
...
/// See glPolygonOffset.
///
/// @return Une chaîne representant l'attribut GL_POLYGON_OFFSET_UNITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_OFFSET_FILL.
///
/// Selon le man page, cet attribut:
///
...
/// glPolygonOffset.
///
/// @return Une chaîne representant l'attribut GL_POLYGON_OFFSET_FILL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_OFFSET_LINE.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether polygon offset is
...
/// glPolygonOffset.
///
/// @return Une chaîne representant l'attribut GL_POLYGON_OFFSET_LINE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_OFFSET_POINT.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether polygon offset is
...
/// glPolygonOffset.
///
/// @return Une chaîne representant l'attribut GL_POLYGON_OFFSET_POINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_SMOOTH.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether antialiasing of
...
///
/// @return Une chaîne representant l'attribut GL_POLYGON_SMOOTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_SMOOTH_HINT.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating the mode of the
...
///
/// @return Une chaîne representant l'attribut GL_POLYGON_SMOOTH_HINT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_POLYGON_STIPPLE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_POLYGON_STIPPLE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PROJECTION_MATRIX.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_PROJECTION_MATRIX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_PROJECTION_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
/// stack. The initial value is 1. See glPushMatrix.
///
/// @return Une chaîne representant l'attribut GL_PROJECTION_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_READ_BUFFER.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_READ_BUFFER.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_RED_BIAS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_RED_BIAS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_RED_BITS.
///
/// Selon le man page, cet attribut:
///
...
/// buffer.
///
/// @return Une chaîne representant l'attribut GL_RED_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_RED_SCALE.
///
/// Selon le man page, cet attribut:
///
...
/// transfers. The initial value is 1. See glPixelTransfer.
///
/// @return Une chaîne representant l'attribut GL_RED_SCALE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_RENDER_MODE.
///
/// Selon le man page, cet attribut:
///
...
/// glRenderMode.
///
/// @return Une chaîne representant l'attribut GL_RENDER_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_RGBA_MODE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_RGBA_MODE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_SCISSOR_BOX.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_SCISSOR_BOX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_SCISSOR_TEST.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_SCISSOR_TEST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_SELECTION_BUFFER_SIZE.
///
/// Selon le man page, cet attribut:
///
...
/// glSelectBuffer.
///
/// @return Une chaîne representant l'attribut GL_SELECTION_BUFFER_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_SHADE_MODEL.
///
/// Selon le man page, cet attribut:
///
...
/// glShadeModel.
///
/// @return Une chaîne representant l'attribut GL_SHADE_MODEL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_BITS.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, the number of bitplanes in the stencil buffer.
///
/// @return Une chaîne representant l'attribut GL_STENCIL_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_CLEAR_VALUE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_CLEAR_VALUE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_FAIL.
///
/// Selon le man page, cet attribut:
///
...
/// glStencilOp.
///
/// @return Une chaîne representant l'attribut GL_STENCIL_FAIL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_FUNC.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_FUNC.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_PASS_DEPTH_FAIL.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating what action is
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_PASS_DEPTH_FAIL.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_PASS_DEPTH_PASS.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, a symbolic constant indicating what action is
...
/// value is GL_KEEP. See glStencilOp.
///
/// @return Une chaîne representant l'attribut GL_STENCIL_PASS_DEPTH_PASS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_REF.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_REF.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_TEST.
///
/// Selon le man page, cet attribut:
///
...
/// and glStencilOp.
///
/// @return Une chaîne representant l'attribut GL_STENCIL_TEST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_VALUE_MASK.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_VALUE_MASK.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STENCIL_WRITEMASK.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STENCIL_WRITEMASK.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_STEREO.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_STEREO.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_SUBPIXEL_BITS.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_SUBPIXEL_BITS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_1D.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_1D.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_BINDING_1D.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_BINDING_1D.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_2D.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_2D.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_BINDING_2D.
///
/// Selon le man page, cet attribut:
///
/// params returns a single value, the name of the texture currently bound to
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_BINDING_2D.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
/// glTexCoordPointer.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
/// glTexCoordPointer.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_TYPE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_COORD_ARRAY_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_GEN_Q.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_GEN_Q.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_GEN_R.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether automatic
...
/// GL_FALSE. See glTexGen.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_GEN_R.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_GEN_S.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether automatic
...
/// GL_FALSE. See glTexGen.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_GEN_S.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_GEN_T.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether automatic
...
/// GL_FALSE. See glTexGen. 
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_GEN_T.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_MATRIX.
///
/// Selon le man page, cet attribut:
///
...
/// glPushMatrix.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_MATRIX.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_TEXTURE_STACK_DEPTH.
///
/// Selon le man page, cet attribut:
///
...
/// stack. The initial value is 1. See glPushMatrix.
///
/// @return Une chaîne representant l'attribut GL_TEXTURE_STACK_DEPTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_ALIGNMENT.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_UNPACK_ALIGNMENT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_LSB_FIRST.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether single-bit pixels
...
/// each unsigned byte. The initial value is GL_FALSE. See glPixelStore.
///
/// @return Une chaîne representant l'attribut GL_UNPACK_LSB_FIRST.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_ROW_LENGTH.
///
/// Selon le man page, cet attribut:
///
...
/// memory. The initial value is 0. See glPixelStore.
///
/// @return Une chaîne representant l'attribut GL_UNPACK_ROW_LENGTH.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_SKIP_PIXELS.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, the number of pixel locations skipped before the
...
///
/// @return Une chaîne representant l'attribut GL_UNPACK_SKIP_PIXELS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_SKIP_ROWS.
///
/// Selon le man page, cet attribut:
///
/// params returns one value, the number of rows of pixel locations skipped
...
/// See glPixelStore.
///
/// @return Une chaîne representant l'attribut GL_UNPACK_SKIP_ROWS.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_UNPACK_SWAP_BYTES.
///
/// Selon le man page, cet attribut:
///
/// params returns a single boolean value indicating whether the bytes of
...
///
/// @return Une chaîne representant l'attribut GL_UNPACK_SWAP_BYTES.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_VERTEX_ARRAY.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_VERTEX_ARRAY.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_VERTEX_ARRAY_SIZE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_VERTEX_ARRAY_SIZE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_VERTEX_ARRAY_STRIDE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_VERTEX_ARRAY_STRIDE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_VERTEX_ARRAY_TYPE.
///
/// Selon le man page, cet attribut:
///
...
///
/// @return Une chaîne representant l'attribut GL_VERTEX_ARRAY_TYPE.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_VIEWPORT.
///
/// Selon le man page, cet attribut:
///
...
/// See glViewport.
///
/// @return Une chaîne representant l'attribut GL_VIEWPORT.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ZOOM_X.
///
/// Selon le man page, cet attribut:
///
...
/// See glPixelZoom.
///
/// @return Une chaîne representant l'attribut GL_ZOOM_X.
///
///////////////////////////////////////////////////////////////////////////////
...
///
/// Cette fonction retourne une chaîne representant l'attribut GL_ZOOM_Y.
///
/// Selon le man page, cet attribut:
///
...
/// 1. See glPixelZoom.
///
/// @return Une chaîne representant l'attribut GL_ZOOM_Y.
///
///////////////////////////////////////////////////////////////////////////////
