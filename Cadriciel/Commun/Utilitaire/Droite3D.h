...
namespace math {
   ...
   ///////////////////////////////////////////////////////////////////////////
   /// @class Droite3D
   /// @brief Classe qui represente une droite en 3 dimensions.
   ///
   /// Classe qui permet d'avoir une droite en 3D. \n
   /// Une droite dans l'espace 3D est definie par l'equation :
   ///
   ///  \f[  \frac {x - x_0 } {a} =  \frac { y - y_0 } {b} =  \frac { z - z_0 } {c}    \f]
   /// où le point @f$ (x_0, y_0, z_0) @f$ est un point de la droite
   /// et le vecteur de direction @f$ (a, b, c) @f$ est un vecteur parallele
   /// a la droite.\n \n
   /// Une droite dans l'espace 3D passant par 2 points @f$  ( P_1, P_2) @f$ est definie par l'equation :
   ///
   ///  \f[  \frac {x - x_1 } {x_2 - x_1} =  \frac { y - y_1 } {y_2 - y_1} =  \frac { z - z_1 } {z_2 - z_1}    \f]
   /// \n\n
   /// Cette classe contient des methodes pour :
   ...
   public:
	  ...
	  Droite3D& operator= (const Droite3D& rhs);

   private:
      /// @f$ (x_0, y_0, z_0) @f$
      Vecteur3 pointDroite_;
      /// @f$ (a, b, c) @f$
      Vecteur3 direction_;
