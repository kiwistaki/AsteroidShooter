/**
 * @file CommandeAjoutAccelerateur.h
...
#ifndef COMMANDE_AJOUT_ACCELERATEUR_H
#define COMMANDE_AJOUT_ACCELERATEUR_H

#include "CommandeModeEdition.h"
#include "../../Carte.h"

/**
 * @class CommandeAjoutAccelerateur
 * @brief La classe CommandeAjoutAccelerateur permet d'ajouter un objet sur la carte.
 */
class CommandeAjoutAccelerateur : public CommandeModeEdition {
	public:
		/**
		 * Constructeur
		 ...
		 */
						CommandeAjoutAccelerateur(const vue::Vue& vue,
												  Carte& carte);

		/**
		 * Destructeur
		 */
		virtual		   ~CommandeAjoutAccelerateur();
