...
/**
 * @class Phont
 * @brief Gère l'affichage de texte basé sur une image de caractères générés par
...
class Phont {
	...
	bool print(GLuint width, GLuint height, GLuint vp_x, GLuint vp_y, bool keep_gl, const char* format, ...) const;
