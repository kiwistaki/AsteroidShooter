...
\subsubsection[{executer}]{\setlength{\rightskip}{0pt plus 5cm}void Commande\-Rotation\-::executer (
\begin{DoxyParamCaption}
\item[{int}]{mouse\-X, }
\item[{int}]{mouse\-Y, }
\item[{int}]{boutton, }
...
Cadriciel/\-Sources/\-C++/\-Application/\-Jeu/\-Mode\-Edition/Commande\-Rotation.\-cpp\end{DoxyCompactItemize}
