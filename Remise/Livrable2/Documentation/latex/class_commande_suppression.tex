...
\subsubsection[{executer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Commande\-Suppression\-::executer (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{mouse\-X, }
\item[{{\bf int}}]{mouse\-Y, }
\item[{{\bf int}}]{boutton, }
...
Cadriciel/\-Sources/\-C++/\-Application/\-Jeu/\-Mode\-Edition/\hyperlink{_commande_suppression_8cpp}{Commande\-Suppression.\-cpp}\end{DoxyCompactItemize}
