...
\subsubsection[{executer}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Commande\-Ajout\-Barriere\-::executer (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{mouse\-X, }
\item[{{\bf int}}]{mouse\-Y, }
\item[{{\bf int}}]{boutton, }
...
Cadriciel/\-Sources/\-C++/\-Application/\-Jeu/\-Mode\-Edition/\hyperlink{_commande_ajout_barriere_8cpp}{Commande\-Ajout\-Barriere.\-cpp}\end{DoxyCompactItemize}
