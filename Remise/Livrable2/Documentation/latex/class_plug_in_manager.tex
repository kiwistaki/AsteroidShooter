...
Constructs a \hyperlink{class_plug_in_manager}{Plug\-In\-Manager} object. \hypertarget{class_plug_in_manager_a093797f2d979b22fcf8df2230985b246}{\index{Plug\-In\-Manager@{Plug\-In\-Manager}!$\sim$\-Plug\-In\-Manager@{$\sim$\-Plug\-In\-Manager}}
\index{$\sim$\-Plug\-In\-Manager@{$\sim$\-Plug\-In\-Manager}!PlugInManager@{Plug\-In\-Manager}}
\subsubsection[{$\sim$\-Plug\-In\-Manager}]{\setlength{\rightskip}{0pt plus 5cm}virtual Plug\-In\-Manager\-::$\sim$\-Plug\-In\-Manager (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_plug_in_manager_a093797f2d979b22fcf8df2230985b246}
...
\subsubsection[{add\-Listener}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::add\-Listener (
\begin{DoxyParamCaption}
...
For each plug-\/in, call \hyperlink{struct_cpp_unit_test_plug_in_aad8038dc72d0f9798379937fe5692c97}{Cpp\-Unit\-Test\-Plug\-In\-::add\-Listener()}. \hypertarget{class_plug_in_manager_a4a9c64e0ac3f762b100b993d7e33f889}{\index{Plug\-In\-Manager@{Plug\-In\-Manager}!add\-Xml\-Outputter\-Hooks@{add\-Xml\-Outputter\-Hooks}}
\index{add\-Xml\-Outputter\-Hooks@{add\-Xml\-Outputter\-Hooks}!PlugInManager@{Plug\-In\-Manager}}
\subsubsection[{add\-Xml\-Outputter\-Hooks}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::add\-Xml\-Outputter\-Hooks (
\begin{DoxyParamCaption}
\item[{{\bf Xml\-Outputter} $\ast$}]{outputter}
\end{DoxyParamCaption}
)}}\label{class_plug_in_manager_a4a9c64e0ac3f762b100b993d7e33f889}


Provides a way for the plug-\/in to register some \hyperlink{class_xml_outputter_hook}{Xml\-Outputter\-Hook}. 
...
\subsubsection[{load}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::load (
\begin{DoxyParamCaption}
...
\hline
\end{DoxyExceptions}
\hypertarget{class_plug_in_manager_aea9b8b61e256169b823516868e1d8ad0}{\index{Plug\-In\-Manager@{Plug\-In\-Manager}!remove\-Listener@{remove\-Listener}}
\index{remove\-Listener@{remove\-Listener}!PlugInManager@{Plug\-In\-Manager}}
\subsubsection[{remove\-Listener}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::remove\-Listener (
\begin{DoxyParamCaption}
\item[{{\bf Test\-Result} $\ast$}]{event\-Manager}
\end{DoxyParamCaption}
)}}\label{class_plug_in_manager_aea9b8b61e256169b823516868e1d8ad0}


Gives a chance to each loaded plug-\/in to unregister \hyperlink{class_test_listener}{Test\-Listener}. For each plug-\/in, call \hyperlink{struct_cpp_unit_test_plug_in_a8f36157014b515d38efbc8ab67923d85}{Cpp\-Unit\-Test\-Plug\-In\-::remove\-Listener()}. 
...
\subsubsection[{remove\-Xml\-Outputter\-Hooks}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::remove\-Xml\-Outputter\-Hooks (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{unload}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Plug\-In\-Manager\-::unload (
\begin{DoxyParamCaption}
\item[{const {\bf std\-::string} \&}]{library\-File\-Name}
\end{DoxyParamCaption}
