...
\item[{{\bf std\-::string}}]{element\-Name, }
\item[{{\bf std\-::string}}]{content = {\ttfamily \char`\"{}\char`\"{}}}
...
\hline
\end{DoxyParams}
\hypertarget{class_xml_element_ac862c3db543830858fba97c6196afd6b}{\index{Xml\-Element@{Xml\-Element}!$\sim$\-Xml\-Element@{$\sim$\-Xml\-Element}}
\index{$\sim$\-Xml\-Element@{$\sim$\-Xml\-Element}!XmlElement@{Xml\-Element}}
\subsubsection[{$\sim$\-Xml\-Element}]{\setlength{\rightskip}{0pt plus 5cm}virtual Xml\-Element\-::$\sim$\-Xml\-Element (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_xml_element_ac862c3db543830858fba97c6196afd6b}
...
\subsubsection[{add\-Attribute}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Xml\-Element\-::add\-Attribute (
\begin{DoxyParamCaption}
\item[{{\bf std\-::string}}]{attribute\-Name, }
\item[{{\bf std\-::string}}]{value}
\end{DoxyParamCaption}
...
\subsubsection[{add\-Element}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Xml\-Element\-::add\-Element (
\begin{DoxyParamCaption}
...
\subsubsection[{content}]{\setlength{\rightskip}{0pt plus 5cm}{\bf std\-::string} Xml\-Element\-::content (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{element\-Count}]{\setlength{\rightskip}{0pt plus 5cm}{\bf int} Xml\-Element\-::element\-Count (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{name}]{\setlength{\rightskip}{0pt plus 5cm}{\bf std\-::string} Xml\-Element\-::name (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{set\-Content}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Xml\-Element\-::set\-Content (
\begin{DoxyParamCaption}
\item[{const {\bf std\-::string} \&}]{content}
\end{DoxyParamCaption}
...
\hline
\end{DoxyParams}
This is an overloaded member function, provided for convenience. It differs from the above function only in what argument(s) it accepts.\hypertarget{class_xml_element_ae8d473f1d193157158ae36e12929d387}{\index{Xml\-Element@{Xml\-Element}!set\-Content@{set\-Content}}
\index{set\-Content@{set\-Content}!XmlElement@{Xml\-Element}}
\subsubsection[{set\-Content}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Xml\-Element\-::set\-Content (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{numeric\-Content}
\end{DoxyParamCaption}
)}}\label{class_xml_element_ae8d473f1d193157158ae36e12929d387}
...
\subsubsection[{set\-Name}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Xml\-Element\-::set\-Name (
\begin{DoxyParamCaption}
\item[{const {\bf std\-::string} \&}]{name}
\end{DoxyParamCaption}
...
\subsubsection[{to\-String}]{\setlength{\rightskip}{0pt plus 5cm}{\bf std\-::string} Xml\-Element\-::to\-String (
\begin{DoxyParamCaption}
