...
\hypertarget{class_test_path_a525c33f5b897710bf37cf593160e562a}{\index{Test\-Path@{Test\-Path}!Path\-Test\-Names@{Path\-Test\-Names}}
\index{Path\-Test\-Names@{Path\-Test\-Names}!TestPath@{Test\-Path}}
...
\hypertarget{class_test_path_aa1f2a0a7e01597a16ed041776297fbdf}{\index{Test\-Path@{Test\-Path}!Tests@{Tests}}
\index{Tests@{Tests}!TestPath@{Test\-Path}}
...
\item[{{\bf int}}]{index\-First, }
\item[{{\bf int}}]{count = {\ttfamily -\/1}}
\end{DoxyParamCaption}
...
\item[{const {\bf std\-::string} \&}]{path\-As\-String}
\end{DoxyParamCaption}
...
\hline
\end{DoxyParams}
\hypertarget{class_test_path_aae2b4ad848df0da549059e6ab146eca2}{\index{Test\-Path@{Test\-Path}!$\sim$\-Test\-Path@{$\sim$\-Test\-Path}}
\index{$\sim$\-Test\-Path@{$\sim$\-Test\-Path}!TestPath@{Test\-Path}}
\subsubsection[{$\sim$\-Test\-Path}]{\setlength{\rightskip}{0pt plus 5cm}virtual Test\-Path\-::$\sim$\-Test\-Path (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [virtual]}}}\label{class_test_path_aae2b4ad848df0da549059e6ab146eca2}
...
\subsubsection[{add}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf void} Test\-Path\-::add (
\begin{DoxyParamCaption}
...
\subsubsection[{check\-Index\-Valid}]{\setlength{\rightskip}{0pt plus 5cm}{\bf void} Test\-Path\-::check\-Index\-Valid (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{index}
\end{DoxyParamCaption}
...
\subsubsection[{get\-Test\-Count}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf int} Test\-Path\-::get\-Test\-Count (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{insert}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf void} Test\-Path\-::insert (
\begin{DoxyParamCaption}
\item[{{\bf Test} $\ast$}]{test, }
\item[{{\bf int}}]{index}
\end{DoxyParamCaption}
...
\subsubsection[{remove\-Test}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf void} Test\-Path\-::remove\-Test (
\begin{DoxyParamCaption}
\item[{{\bf int}}]{index}
\end{DoxyParamCaption}
...
\subsubsection[{remove\-Tests}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf void} Test\-Path\-::remove\-Tests (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{to\-String}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf std\-::string} Test\-Path\-::to\-String (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{up}]{\setlength{\rightskip}{0pt plus 5cm}virtual {\bf void} Test\-Path\-::up (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\hypertarget{class_test_path_aeda882fdb18011525ab63a6543648090}{\index{Test\-Path@{Test\-Path}!m\-\_\-tests@{m\-\_\-tests}}
\index{m\-\_\-tests@{m\-\_\-tests}!TestPath@{Test\-Path}}
\subsubsection[{m\-\_\-tests}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Tests} Test\-Path\-::m\-\_\-tests\hspace{0.3cm}{\ttfamily [protected]}}}\label{class_test_path_aeda882fdb18011525ab63a6543648090}
