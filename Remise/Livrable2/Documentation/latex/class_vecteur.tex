...
\hypertarget{class_vecteur_a06c3800145756744698c41603078d0a4}{\index{Vecteur@{Vecteur}!convertir@{convertir}}
\index{convertir@{convertir}!Vecteur@{Vecteur}}
\subsubsection[{convertir}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T = double, const int N = 3$>$ template$<$const int N2$>$ {\bf Vecteur}$<$T, N2$>$ {\bf Vecteur}$<$ T, N $>$\-::convertir (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{class_vecteur_a06c3800145756744698c41603078d0a4}
\hypertarget{class_vecteur_a5fe93e22709412c575e369b6295549d5}{\index{Vecteur@{Vecteur}!convertir@{convertir}}
\index{convertir@{convertir}!Vecteur@{Vecteur}}
\subsubsection[{convertir}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T = double, const int N = 3$>$ template$<$class T2 , const int N2$>$ {\bf Vecteur}$<$T2, N2$>$ {\bf Vecteur}$<$ T, N $>$\-::convertir (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [inline]}}}\label{class_vecteur_a5fe93e22709412c575e369b6295549d5}
...
\subsubsection[{normaliser}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class T = double, const int N = 3$>$ {\bf void} {\bf Vecteur}$<$ T, N $>$\-::normaliser (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\hypertarget{class_vecteur_a2c2224d33b1b96b4cb75f010d5ec1d97}{\index{Vecteur@{Vecteur}!vect@{vect}}
\index{vect@{vect}!Vecteur@{Vecteur}}
